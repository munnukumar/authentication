...
export const createUserTokens = (user: Omit<IUser, "password">) => {
    ...
    // Set default expiry values if not defined in the environment
    // const accessTokenExpiry = process.env.ACCESS_TOKEN_EXPIRY ?? "30m"; // Default 30 minutes
    // const refreshTokenExpiry = process.env.REFRESH_TOKEN_EXPIRY ?? "2d"; // Default 2 days
